...
For example, the code is currently extremely incomplete and buggy, while it may throw up a tabulated list of torrents, the only action supported on the list is sort by column.
